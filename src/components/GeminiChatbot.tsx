...
export function GeminiChatbot({ domainContext }: GeminiChatbotProps) {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([
        {
          role: 'assistant',
          content: `Hi! I'm your AI Domain Advisor for **${domainContext.domainName}**. I have full context about this domain including its score (${domainContext.aiScore}/100), transaction history, pricing, and market analysis. Ask me anything!`,
          timestamp: Date.now(),
        },
      ])
    }
  }, [isOpen, domainContext.domainName, domainContext.aiScore, messages.length])
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-purple-600 to-blue-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group z-50"
        ...
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl flex flex-col z-50 border border-gray-200 dark:border-gray-700">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-semibold">AI Domain Advisor</h3>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                disabled={isLoading}
              />
              <button
